\section{Input/output}
      ...
      \begin{figure}[H]
      \begin{center}
  \subfloat[Puma density t=360]{\includegraphics[width=40mm]{figs/Puma900.jpg}}
  \subfloat[Puma density t=416]{\includegraphics[width=40mm]{figs/Puma1040.jpg}}
      \caption{This figure shows examples of the output files created during a simulation using a $100 \times 100$ grid and default initial conditions. Various shades of grey represent the density of pumas after 900 and 1040 time steps, with time step size set to 0.4.}
      \end{center}
      \end{figure}
