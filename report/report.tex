...
\node [block, below of=GridAlg] (InputFrame) {GUI\\ \ref{sec:InputFrame}};
...
It is called in the PredPrey class where it' values are initialised from those taken from the GUI or input file.
...
\subsubsection{GUI}
This class is responsible for displaying a GUI for a user to input parameters of the simulation
