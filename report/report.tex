...
\title{Predator Prey Model\footnote{When writing this report, a lot of emphasis was put on interactivity, so, a reader would benefit from reading an electronic version (PDF) rather than a paper one}}
\author{Names Here}
\date{November 2011}
