...
\chapter{Design \& Implementation}
   \section{Code}
      ...
      \begin{figure}[H]
      \begin{center}
      \includegraphics[width=100mm,height=130mm]{figs/hare.pdf}
      \caption{This figure shows one of the output files created during a simulation using a $100 \times 100$ grid and default initial conditions. Various shades of grey represent the density of hares after 50 time steps, with a tie step set to 0.4.}
      \end{center}
      \end{figure}
